...
<main class="container">
    <div>
        ...
        <a title="Copy" onclick="return confirm('Are you sure you want to Copy?')"
            href="projectcopy?pid=<?= $pid ?>"><img class="icon" src="views/imgs/icons/copy.png"></a>
        <a title="Delete" onclick="return confirm('Are you sure you want to Delete?')"
            href="projectdelete?id=<?= $pid ?>" class="<?= $disable ?>"><img class="icon"
    ...
    <div class="container mt-2">
        ...
        <div class="d-inline-block">
            <div class="card mb-2 w-auto ml-2">
                ...
                <div class="card-body">
                    ...
                    <a title="Delete"
                        onclick="return confirm(' Are you sure you want to delete <?= user($userid['userid']) ?> from this project?')"
                        href="projectuserDel?uid=<?= $userid['userid'] ?>&pid=<?= $pid ?>" class="<?= $disable ?>"><img
                            class="icon25" src="views/imgs/icons/delete.png"></a>
                    <br>
                    <?php }
                        ?>
                </div>
        ...
        <table class="table table-striped rounded rounded-5 overflow-hidden">
            ...
            <?php $authorOrassigned = $row['author'] ?? $row['assignuser'] ?? ""; ?>
            <?php $disable =  authBtns($_SESSION['uid'], $authorOrassigned, $_SESSION['role']); ?>
            ...
            <tr class="<?= $class ?>">
                ...
                <td>
                    <a title="Copy" onclick="return confirm('Are you sure you want to Copy <?= $row['title']; ?> ?')"
                        href="taskcopy?tid=<?= $row['id'] ?>">
                        <img class="icon" src="views/imgs/icons/copy.png"></a>
                    <a title="Edit" href="taskupdate?tid=<?= $row['id'] ?>&pid=<?= $pid ?>" class="<?= $disable ?>">
                        <img class="icon" src="views/imgs/icons/edit.png"></a>
                    <a title="Delete"
                        onclick="return confirm('Are you sure you want to Delete <?= $row['title']; ?> ?')"
                        href="taskdelete?tid=<?= $row['id'] ?>&pid=<?= $pid ?>" class="<?= $disable ?>">
